...
const mockdata = [
    {
        icon: IconCode,
        title: "Nearby Help",
        description: "Find authorities around you",
    ...
    },
    {
        icon: IconBook,
        title: "Location",
        description: "Check your area's security",
        url: "https://google.com"
    },
    {
        icon: IconBook,
        title: "Add Contacts",
        description: "Feed emergency contact info",
        url: "https://google.com"
    },
...
export default function HeaderMegaMenu() {
        ...
        <UnstyledButton className={classes.subLink} >
            <Group noWrap align="flex-start">
                <ThemeIcon size={34} variant="default" radius="md">
                    <item.icon size={rem(18)} color={theme.fn.primaryColor()} />
                </ThemeIcon>
                <div>
                    <Text size="sm" fw={500}>
                        {item.title}
    ...
    return (
        <Box pb={20} pt={10}>
            <Header height={100} style={{ borderBottom: 0 }}>
