...
const data = [
    {
        image: "/images/ngo2.avif",
        name: "NGO 1",
        type: "Women Welfare",
        hospital: "Rajpur Road",
    },
    {
        image: "/images/ngo.jpg",
        name: "NGO 2",
        type: "Women Safety",
        hospital: "Clement Town",
    },
    {
        image: "/images/ngo2.avif",
        name: "NGO 3",
        type: "Women and Child Welfare",
        hospital: "Subhashnagar",
    },
    {
        image: "/images/ngo.jpg",
        name: "NGO 4",
        type: "Anti Abuse",
        hospital: "Gandhi Road",
    },
    {
        image: "/images/ngo2.avif",
        name: "NGO 5",
    ...
    return (
        <>
            <div className={classes.heading}>
                ...
                <span className={classes.title}>Connect with our top NGOs</span>
            </div>
            <Carousel
                slideSize="240px"
                slideGap="60px"
